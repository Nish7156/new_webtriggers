...
function MarqueeText() {
  return (
    <>
      <section class="page-section bg-dark-1 light-content overflow-hidden">
        <div class="marquee marquee-style-5 mt-n40 mt-sm-n20 mt-xs-0 mb-80 mb-sm-60">
          <div class="marquee-track marquee-animation-3">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-11 col-lg-10 offset-1 px-md-4">
              <div class="row gx-huge">
                <div class="col-md-6 mb-100 mb-md-60">
                  <div class="position-relative">
                    <div class="features-1-number">01</div>
                    ...
                    <div class="features-1-title mb-40">
                      Unique <br />
                      <span class="font-alt">Design</span>
                    </div>

                    <hr class="mt-0 mb-30 white opacity-025" />

                    <p class="features-1-descr mb-0">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      In sem dolor, rhoncus eleifend fermentum vel, bibendum vel
                      neque. Cras eu elementum enim. Curabitur elit leo,
                      fringilla in velit at, fermentum semper augue. Vestibulum
                      sit amet venenatis metus. Aenean a arcu sed augue
                      consequat sagittis.
                    </p>
                  </div>
                </div>

                <div class="col-md-6 mt-n140 mt-sm-0 mb-100 mb-md-60">
                  <div class="position-relative">
                    <div class="features-1-number">02</div>
                    ...
                    <div class="features-1-title mb-40">
                      Quality <br />
                      <span class="font-alt">Code</span>
                    </div>

                    <hr class="mt-0 mb-30 white opacity-025" />

                    <p class="features-1-descr mb-0">
                      Praesent nec tempus dui. Curabitur molestie, sapien semper
                      dictum porttitor, odio ipsum hendrerit urna, quis rutrum
                      mi tortor quis velit. Nulla scelerisque eu nisi id
                      volutpat. Nullam fringilla, eros ut semper tincidunt,
                      massa ante congue erat, in vestibulum nibh urna vitae
                      lorem aliquet ornare.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-md-6 mb-md-60">
                  <div class="position-relative">
                    <div class="features-1-number">03</div>
                    ...
                    <div class="features-1-title mb-40">
                      Clean and <br />
                      <span class="font-alt">Minimal</span>
                    </div>

                    <hr class="mt-0 mb-30 white opacity-025" />

                    <p class="features-1-descr mb-0">
                      Integer sit amet nunc sem. Quisque scelerisque dui id
                      fermentum venenatis. Cras non tempor nisi. Aliquam
                      lobortis ligula id efficitur iaculis ipum. Curabitur elit
                      leo, fringilla in velit at, fermentum semper augue.
                      Vestibulum sit amet venenatis metus. Aenean a arcu sed
                      augue consequat sagittis.
                    </p>
                  </div>
                </div>

                <div class="col-md-6 mt-n140 mt-sm-0 mb-0">
                  <div class="position-relative">
                    <div class="features-1-number">04</div>
                    ...
                    <div class="features-1-title mb-40">
                      Premium <br />
                      <span class="font-alt">Suport</span>
                    </div>

                    <hr class="mt-0 mb-30 white opacity-025" />

                    <p class="features-1-descr mb-0">
                      Aliquam nec erat eleifend, volutpat dolor eu, ultrices
                      erat. Etiam et arcu nec quam laoreet hendrerit eget sed
                      velit. Nullam dapibus magna odio. Fusce convallis elit at
                      ex sodales, quis maximus augue hendrerit. Phasellus eget
                      turpis vel nibh convallis vulputate. Lorem ipsum dolor sit
